            ...
            <section id="resume-section" className="about-me-section">
                <div className="container">
                    ...
                    <div className="info">
                        ...
                        <br/>
                        Outside of work, I enjoy engaging in sports and outdoor activities. My hobbies help me maintain
                ...
                <div className="cv-info">
                    ...
                    <div className="column">
                        ...
                        <p>
                            ...
                            Implemented new features of an existing system, contributing to its enhanced functionality
                            and usability.
                            Estimated production times and staging requirements for new designs, enabling the team to
                            deliver projects on time and within budget.
                            Troubleshot new and existing product problems involving designs, materials, or processes,
            ...
            <section id="projects-section" className="project-section">
                ...
                <div className="desc-container">
                    <div className="desc-info">
                        Wishlist - app that allows you to save all your plans for shopping and share it with friends.
                        App allows you to create custom witlists (tables with list of wishes) and share it with friends.
                        Technologies used:
                        <ul>
                            <li>React</li>
                            <li>MonogoDB</li>
                ...
                <div className="rotate-180">
                    <svg className="waves-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                         viewBox="0 24 150 28" preserveAspectRatio="none" shapeRendering="auto">
                        <defs>
                            <path id="gentle-wave"
                                  d="M-160 44c30 0 58-18 88-18s 58 18 88 18 58-18 88-18 58 18 88 18 v44h-352z"/>
